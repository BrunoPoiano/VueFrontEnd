<template>
  <div>
    <main class="testimonial-grid">
      <article class="testimonial grid-col-span-2 testimonial-purple">
        <div class="flex">
          <div>
            <img src="@/assets/tony.jpg" alt="daniel clifford" />
          </div>
          <div>
      ...
      <article class="testimonial testimonial-gray">
        <div class="flex">
          <div>
            <img src="@/assets/tony.jpg" alt="Jonathan Walters" />
          </div>
          <div>
      ...
      <article class="testimonial testimonial-white">
        <div class="flex">
          <div>
            <img src="@/assets/tony.jpg" alt="Jeanette Harmon" />
          </div>
          <div>
      ...
      <article class="testimonial grid-col-span-2 testimonial-dark-blue">
        <div class="flex">
          <div>
            <img
      ...
      <article class="testimonial testimonial-white">
        <div class="flex">
          <div>
            <img src="@/assets/tony.jpg" alt="Kira Whittle" />
          </div>
          <div>
